...
import 'package:restaurant/utils/input_sanitizer.dart';
...
class AddProductController extends GetxController {
  ...
  saveDetails() async {
    ...
    if (selectedProductCategory.value.id == null) {
    ...
    } else if (InputSanitizer.containsDangerousContent(
        productDescriptionController.value.text)) {
      ShowToastDialog.showToast(
          "Description contains invalid content (script tags, event handlers, or HTML tags are not allowed)."
              .tr);
      ...
      productModel.value.description =
          InputSanitizer.sanitize(productDescriptionController.value.text);
      ...
      productModel.value.name =
          InputSanitizer.sanitize(productTitleController.value.text);
