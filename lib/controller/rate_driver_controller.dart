  ...
  getArgument() async {
    ...
    if (argumentData != null) {
      ...
      if (orderModel.value.driverID != null &&
        ...
        await FireStoreUtils.getUserById(orderModel.value.driverID!)
            .then((value) {
          if (value != null) {
      ...
      await FireStoreUtils.getDriverRatingByOrderId(
  ...
  Future<bool> submitRating() async {
    ...
    try {
      RatingModel ratingModel = RatingModel(
        ...
        driverId: orderModel.value.driverID,
      ...
      bool success = await FireStoreUtils.saveDriverRating(ratingModel);

      if (success) {
        // Update driver's average rating
        await FireStoreUtils.updateDriverAverageRating(
            orderModel.value.driverID!);
