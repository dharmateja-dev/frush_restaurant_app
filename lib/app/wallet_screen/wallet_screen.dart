...
class WalletScreen extends StatelessWidget {
  ...
  datePicker(BuildContext context, WalletController controller) {
          ...
          child: Column(
            children: [
              SfDateRangePicker(
                ...
                startRangeSelectionColor: AppThemeData.secondary300,
                endRangeSelectionColor: AppThemeData.secondary300,
                backgroundColor: AppThemeData.grey50,
                rangeSelectionColor: AppThemeData.success50,
                          ...
                          onPress: () async {
                            if (controller
                              ...
                              ShowToastDialog.showToast(
                                ...
                                .noteTextFieldController.value.text.isEmpty) {
