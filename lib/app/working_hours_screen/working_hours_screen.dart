                              ...
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: controller
                                      .workingHours[index].timeslot!.length,
                                                    ...
                                                    if (startTime
                                                      ...
                                                      ShowToastDialog.showToast(
                                                        ...
                                                        .isAtSameMomentAs(
                                                            endTime)) {
                                                      ShowToastDialog.showToast(
                                                          "Start and end time cannot be the same. Please set a valid time duration."
                                                              .tr);
                                                    } else {
                                                      if (endTimeOfDay
                                                              .format(context)
              ...
              child: Padding(
                ...
                child: RoundedButtonFill(
                  ...
                  onPress: () async {
                    ...
                    // Check for zero-duration slots (start time = end time)
                    if (!isEmptyField) {
                      for (var element in controller.workingHours) {
                        for (var slot in element.timeslot!) {
                          if (slot.from == slot.to && slot.from!.isNotEmpty) {
                            ShowToastDialog.showToast(
                                "Start and end time cannot be the same for ${element.day}. Please set a valid time duration."
                                    .tr);
                            isEmptyField = true;
                            break;
                          }
                    ...
                    // Check that at least one day has working hours
                    if (!isEmptyField) {
                      bool hasAnyWorkingHours = false;
                      for (var day in controller.workingHours) {
                      ...
                      if (!hasAnyWorkingHours) {
                        ShowToastDialog.showToast(
                            "Please add working hours for at least one day."
                                .tr);
                        isEmptyField = true;
                      }
                    }
