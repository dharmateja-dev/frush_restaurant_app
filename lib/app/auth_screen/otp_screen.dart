                            ...
                            onPress: () async {
                              ...
                              if (controller.isLocked.value) {
                                ShowToastDialog.showToast(
                                  "Account temporarily locked. Try again in ${controller.lockoutTimeRemaining.value} seconds"
                                      .tr,
                                );
                                return;
                              }
                              ...
                              if (controller.otpController.value.text.length ==
                                ...
                                await FirebaseAuth.instance
                                  ...
                                  controller.handleInvalidOtpAttempt();
                                });
                              } else {
                          ...
                          if (controller.isLocked.value)
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  "Too many attempts. Try again in ${controller.lockoutTimeRemaining.value}s"
                                      .tr,
                            ...
                            TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  ...
                                  text: controller.isLocked.value
                                      ? 'Resend disabled (${controller.lockoutTimeRemaining.value}s)'
                                          .tr
                                      : 'Send Again'.tr,
                                  style: TextStyle(
