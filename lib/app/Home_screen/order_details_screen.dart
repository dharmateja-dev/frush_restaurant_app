...
class OrderDetailsScreen extends StatelessWidget {
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  controller.orderModel.value.scheduleTime ==
                                          null
                                      ? const SizedBox()
                                      : Row(
                                          children: [
                                  ...
                                  controller.orderModel.value.notes == null ||
                                          controller
                                              .orderModel.value.notes!.isEmpty
                                      ? const SizedBox()
                                      : Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      ...
                                      /// 🎉 SPECIAL OCCASION
                                      if (controller.orderModel.value.specialOccasion != null &&
                                          controller.orderModel.value.specialOccasion!
                                              .toString()
                                              .isNotEmpty)
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Text(
                                                controller.orderModel.value.specialOccasion.toString(),
                                                style: TextStyle(
                                      ...
                                      /// 📝 ADDITIONAL REQUEST
                                      if (controller.orderModel.value.notes != null &&
                                          controller.orderModel.value.notes!.toString().isNotEmpty)
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            const SizedBox(height: 8),
  ...
  viewRemarkDialog(
      OrderDetailsController controller, themeChange, OrderModel orderModel) {
    return Dialog(
