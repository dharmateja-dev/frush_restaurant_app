...
class HomeScreen extends StatelessWidget {
                              ...
                              ? RoundedButtonFill(
                                  ...
                                  onPress: () async {
                                    ...
                                    if (orderModel.scheduleTime != null) {
                                      ...
                                      controller.driverUserListFromDriver
                                          .clear();
                                      controller.selectDriverUserFromDriver
                                          .value = UserModel();
                    ...
                    children: [
                      ...
                      Expanded(
                        child: orderModel.takeAway == true
                            ...
                            : orderModel.status == Constant.driverRejected
                                ? RoundedButtonFill(
                                ...
                                : RoundedButtonFill(
                                    ...
                                    height: 5,
                                    onPress: () async {
                                      // Show order details or status info
                                      ShowToastDialog.showToast(
  ...
  Widget paymentTypeChip(OrderModel order) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isCod ? Colors.orange.shade100 : Colors.green.shade100,
                            ...
                            if (controller.estimatedTimeController.value.text
                              ...
                              if (Constant.isSelfDeliveryFeature == true &&
                                  controller.vendermodel.value.isSelfDelivery ==
                                      true &&
                                  orderModel.takeAway == false) {
                                // Self delivery flow: get drivers and show selection dialog
                                ShowToastDialog.showLoader('Please wait...'.tr);
                              ...
                              } else if (orderModel.takeAway == true) {
                                // Takeaway flow: only set estimated time and confirm the order (no driver assignment)
                                ShowToastDialog.showLoader('Please wait...'.tr);
                                orderModel.estimatedTimeToPrepare = controller
                                    .estimatedTimeController.value.text;

                                // Subscription deduction already handled above
                                ...
                                // Regular delivery flow: fetch drivers and show selection dialog
                                ShowToastDialog.showLoader('Please wait...'.tr);
                                await controller.getAllDriverListFromDriver();
                                ShowToastDialog.closeLoader();
                                orderModel.estimatedTimeToPrepare = controller
                                    .estimatedTimeController.value.text;
                                Get.back();
                                showDialog(
                                  ...
                                  context: context,
                                  builder: (BuildContext context) {
                                    return showListOfDeliverymenDialogDriver(
                                        controller, themeChange, orderModel);
                                  },
                                );
                              }
