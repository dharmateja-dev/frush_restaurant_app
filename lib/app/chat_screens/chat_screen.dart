...
import 'package:restaurant/widget/firebase_pagination/firebase_pagination.dart';
                  ...
                  child: GestureDetector(
                    ...
                    child: FirestorePagination(
                      ...
                      query: FirebaseFirestore.instance
                          .collection(
                              controller.chatType.value.toLowerCase() == "admin"
                                  ? CollectionName.chatAdmin
                                  : controller.chatType.value.toLowerCase() ==
                                          "driver"
                                      ? 'chat_driver'
                                      : 'chat_restaurant')
    ...
    final action = CupertinoActionSheet(
      ...
      actions: <Widget>[
          ...
          onPressed: () async {
            ...
            if (galleryVideo != null) {
              ...
              if (videoContainer != null) {
                controller.sendMessage('', videoContainer.videoUrl,
        ...
        CupertinoActionSheetAction(
          ...
          onPressed: () async {
            Get.back();
            XFile? recordedVideo = await controller.imagePicker
