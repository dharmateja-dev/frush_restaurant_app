...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    canvasColor: themeChange.getThem()
        ? AppThemeData.grey900
        : Color.fromRGBO(248, 255, 247, 1), 
  ),
    ...
    checkboxTheme: CheckboxThemeData(
      fillColor: MaterialStateProperty.resolveWith<Color?>((states) {
        if (states.contains(MaterialState.selected)) {
          return AppThemeData.secondary300;  // checked color
        }
      ...
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10),
                                ...
                                child: DropdownSearch<AttributesModel>.multiSelection(
                            ...
                            children: [
                              ...
                              InkWell(
                                  ...
                                  child: SvgPicture.asset(
                                      "assets/icons/ic_add_one.svg",colorFilter: ColorFilter.mode(AppThemeData.secondary300, BlendMode.srcIn),))
                            ],
                          ),
                          const SizedBox(
                            height: 10,
  ...
  buildBottomSheet(BuildContext context, AddProductController controller) {
    return showModalBottomSheet(
      backgroundColor: AppThemeData.success50,
        context: context,
        builder: (context) {
          final themeChange = Provider.of<DarkThemeProvider>(context);
    ...
    final action = CupertinoActionSheet(
      ...
      actions: <Widget>[
        CupertinoActionSheetAction(
          ...
          child: Text('Choose image from gallery'.tr,style: TextStyle(
            color:AppThemeData.secondary300
          ),),
        ),
        CupertinoActionSheetAction(
          ...
          child: Text('Take a picture'.tr,style: TextStyle(
            color:AppThemeData.secondary300
          ),),
        ),
      ],
