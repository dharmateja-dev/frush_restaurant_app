...
import 'package:restaurant/controller/rate_customer_controller.dart';
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // Customer Name
                                Text(
                                  "${controller.customerModel.value.firstName ?? ''} ${controller.customerModel.value.lastName ?? ''}"
                                      .trim(),
                                  style: TextStyle(
                                    color: themeChange.getThem()
                                ...
                                ClipRRect(
                                  ...
                                  child: NetworkImageWidget(
                                    imageUrl: controller.customerModel.value
                                            .profilePictureURL ??
                                        '',
                                    height: 80,
                                    width: 80,
